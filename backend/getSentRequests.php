<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $sql = "SELECT * FROM connections WHERE pet_id_send = '$pet_id_send' AND request_status = '$status'";
        ...
        if ($result->num_rows > 0) {
            ...
            $response = array('success' => false, 'error' => 'No requests found for the entered sender ID.');
        }
